...
pub fn questions(_answer: &str) {
    ...
    (6) Como tornar um arquivo imutável dentro do cofre?
   ...
   match _answer {
    ...
    "6" => println!("Para tornar um arquivo imutável dentro do cofre, use o comando 'make-immutable (caminho_do_arquivo)'."),
    "7" => println!("Funcionalidade futuras serão anunciadas em breve! no momento estaremos focados em verificação de chaves usb para a adição de chaves de segurança para não permitir a exclusão por meio de arquivos maliciosos,
